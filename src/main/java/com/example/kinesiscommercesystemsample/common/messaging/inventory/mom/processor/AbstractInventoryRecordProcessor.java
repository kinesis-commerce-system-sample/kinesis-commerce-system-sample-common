package com.example.kinesiscommercesystemsample.common.messaging.inventory.mom.processor;
...
@Slf4j
public abstract class AbstractInventoryRecordProcessor implements KinesisRecordProcessor<InventoryMessage> {
	...
	public void processRecords(List<Record> records, IRecordProcessorCheckpointer checkpointer) {
		...
		for (Record record : records) {
			try {
				val message = objectMapper.readValue(record.getData().array(), InventoryMessage.class);
