package com.example.kinesiscommercesystemsample.common.messaging.order.mom.processor;
...
@Slf4j
public abstract class AbstractOrderRecordProcessor implements KinesisRecordProcessor<OrderMessage> {
	...
	public void processRecords(List<Record> records, IRecordProcessorCheckpointer checkpointer) {
		...
		for (Record record : records) {
			try {
				val message = objectMapper.readValue(record.getData().array(), OrderMessage.class);
